...
<html>
    <head>
        ...
        <link href="EstilosS/eliminaS.css" type="text/css" rel="stylesheet"/>
...
<br><br>   
        ...
        <form id="formulario" action="elimina_servicios">
        <h3 class="text">Digite el CÓDIGO del servicio a eliminar</h3>
            <input class="Ctexto" text="Ctexto" type="text" name="codS"><p>
