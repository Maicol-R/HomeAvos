...
<head>
        ...
        <link href="EstilosS/consultaS.css" rel="stylesheet" type="text/css">
...
<br><br>
        <form id="formulario" action="busca_servicios">
              
            </select>
            <p>
            <h3 class="text">Digite el CÓDIGO del servicio a Consultar</h3>
