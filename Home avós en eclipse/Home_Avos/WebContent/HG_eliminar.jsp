...
<html>
    ...
    <link href="EstilosHG/eliminarHG.css" type="text/css" rel="stylesheet"/>
        <meta http-equiv="HG_eliminar" content="text/html; charset=UTF-8">
        <title>Eliminar Hogar Geriatrico</title>
    </head>
    <body>
...
<br><br>   
        ...
        <form id="formulario" action="elimina_hogarGeriatrico">
        <h3 class="text">Digite el NIT del hogar geriátrico a eliminar</h3>
            <input class="Ctexto" text="Ctexto" type="text" name="nitHG"></br>
