...
<head>
     ...
     <link href="Estilos/D_pagoE.css" type="text/css" rel="stylesheet"/>
...
<nav class="navbar navbar-expand-lg navbar" style="height:60px; background-color:#08a1ff; margin-left:20%; margin-right:20%;  border-bottom: #FFFFFF 2px solid; border-top: #FFFFFF 2px solid;" >
  ...
  <textfiel class="nombreHogar" readonly style="margin-left:20%; height: 50px;width: 60%;" class="texarea" type="text" name=" "> Plan Estandar de Hogar Geriatrico- Corporacion Home Avos </textfiel>
...
<form action="registra_Planmembresia" class="formulario">
        ...
        <div class="form-group">
            ...
            <textarea readonly style="margin-left:20%; height: 50px;width: 60%;" class="texarea" type="text" name="codPlan"> 201547</textarea>
            </div>
        <div class="form-group">
           <label for="exampleInputEmail1" style="margin-left:20%;"> NOMBRE PLAN</label>
            <textarea readonly style="margin-left:20%; height: 50px;width: 60%;" class="texarea" type="text" name="nombre"> PLAN ESTANDAR DE HOGAR GERIATRICO</textarea>
            </div>
             <div class="form-group">
        ...
        <option>Paypal</option>
          ...
          <textarea readonly style="margin-left:20%; height: 50px;width: 60%;" class="texarea" type="text" name="duracion"> 6 MESES </textarea>
            </div>
       <div class="form-group">
            <label for="exampleInputEmail1" style="margin-left:20%;">DESCRIPCION</label><br>
           <textarea readonly style="margin-left:20%; height: 130px;width: 60%;" class="texarea" type="text" name="descripcion"> Este plan Estandar obtiene Hogares y servicos a un costo intermedio, permitiendo que cualquier familiar  pueda adquirirlo sin ningun compromiso y optener  sus beneficios para darle a su familiar lo que se merece .</textarea>
           
        <div class="form-group">
            <label for="exampleInputEmail1" style="margin-left:20%;">PRECIO</label><br>
           <textarea readonly style="margin-left:20%; height: 130px;width: 60%;" class="texarea" type="text" name="precio"> $1.600.000  </textarea>
