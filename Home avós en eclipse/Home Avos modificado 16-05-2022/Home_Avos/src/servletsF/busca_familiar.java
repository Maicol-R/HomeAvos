 ...
 */
@WebServlet("/busca_familiar")
public class busca_familiar extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            familiar = (ArrayList) a.buscar(dato);
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }
       // request.getSession().setAttribute("todos", aprendices);//revisar getSession
        request.setAttribute("familiar", familiar);//Se envía con request 
        RequestDispatcher r = request.getRequestDispatcher("F_buscarResultado.jsp");
