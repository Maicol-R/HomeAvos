...
<link href="EstilosAM/eliminaEstilos.css" type="text/css" rel="stylesheet">
<meta charset="ISO-8859-1">
<title>Eliminar Adulto Mayor</title>
</head>
<body>
...
<section>
<br><br>
<h1 class="titulo">Eliminar Postulación</h1>
<br><br>

<form action="elimina_adultoMayor" class="formulario">
