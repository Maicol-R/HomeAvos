...
<html>
    <head>
        ...
        <link href="EstilosF/buscarF.css" type="text/css" rel="stylesheet"/>
...
<br><br>
 <section>
        ...
        <form id="formulario" action="busca_familiar">
              
            </select>
            <p>
            <h3 class="text">Escriba el N° Documento del familiar a consultar</h3>
