...
<link rel="icon" href="images/icono2.ico">
    ...
    <link href="EstilosAD/eliminarAD.css" type="text/css" rel="stylesheet"/>
   ...
   <br><br> 
<h1 class="titulo">Eliminar Administrador</h1> 
        
   <br><br>
   <section class="contenedor">
        <form id="formulario" action="elimina_administrador"><br>
        <h3 class="text">Digite el N° documento del administrador a eliminar</h3>
            <input class="Ctexto" text="Ctexto" type="text" name="nDocAD"></br>
